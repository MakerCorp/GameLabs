    ...
    public partial class HuntingGame : Form
    {
        ...
        private void keyisdown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Left)
            {
                ...
                picPlayer.Image = Properties.Resources.PlayerLeft; // change the player image to LEFT image
            }
            ...
            if (e.KeyCode == Keys.Right)
            {
                ...
                picPlayer.Image = Properties.Resources.PlayerRight; // change the player image to right
            }
            ...
            if (e.KeyCode == Keys.Up)
            {
                ...
                picPlayer.Image = Properties.Resources.PlayerUp; // change the player image to up
            ...
            if (e.KeyCode == Keys.Down)
            {
                ...
                picPlayer.Image = Properties.Resources.PlayerDown; // change the player image to down
            }
